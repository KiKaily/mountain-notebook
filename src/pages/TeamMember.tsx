        ...
        <div className="flex flex-col md:flex-row items-start gap-12">
          ...
          <div className="flex-1 space-y-8">
            ...
            <div className="space-y-6">
              {member.name === "José Andrés Mingorance" ? (
                <>
                  <div>
                    ...
                    <p className="text-base md:text-lg font-sans leading-relaxed text-foreground opacity-75">
                      Acompanyant en projectes d'Educació Viva i Educador Emocional en el Lleure.<br /><br />
                      Format en diferents pedagogies educatives i en Enginyeria. El seu camí vital forma part del seu procés d'aprenentatge.
                    </p>
                  </div>
                  <div>
